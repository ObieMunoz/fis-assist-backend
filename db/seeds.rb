...
prework = Course.create(
    title: "Prework",
    description: "HTML, CSS, and JavaScript"
)

phase1 = Course.create(
    title: "Phase 1",
    description: "JavaScript"
)

phase2 = Course.create(
    title: "Phase 2",
    description: "React"
)

phase3 = Course.create(
    title: "Phase 3",
    description: "Ruby"
)

phase4 = Course.create(
    title: "Phase 4",
...
Question.create(
    ...
    answer: "STEP ONE: Do not forget to run npm install to install the lab's dependencies.
