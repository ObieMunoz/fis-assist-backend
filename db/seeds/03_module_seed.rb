...
Mod.create(title: 'Programming as Conversation Part 1: Expressions', course_id: 1)
Mod.create(title: 'Programming as Conversation Part 2: Statements', course_id: 1)
Mod.create(title: 'Programming as Conversation Part 3: Bundling Expressions and Statements into Functions', course_id: 1)
...
Mod.create(title: "Introducing Flatiron's Three Pillars of JavaScript", course_id: 2)
...
Mod.create(title: 'Additional Practice: HTML Forms and Modern Elements', course_id: 2)
...
Mod.create(title: 'Topics in OO - Class Variables and Methods in Ruby', course_id: 4)
